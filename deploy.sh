...
echo "2. Select 'Deploy from GitHub repo' and connect your repository"
echo "3. Railway will automatically detect your Node.js app and configure:"
echo "   - Build Command: cd backend && npm install"
echo "   - Start Command: cd backend && npm start"
echo ""
echo "4. Set these environment variables in Railway Variables tab:"
...
echo "   REACT_APP_API_URL=https://your-backend-domain.up.railway.app"
echo "   REACT_APP_WS_URL=wss://your-backend-domain.up.railway.app"
echo ""
